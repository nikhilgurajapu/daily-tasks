...
class flyover:
    def flyable(self):
        self.flying = input("enter the flyable: ")
...
class eagle(bird,flyover):
    ...
    def display(self):
        ...
        print("flying capability; ",self.flying)
...
p = Manager("Nikhil", 24, 23000, "manager")
p.display()
...
e.display()
d = Developer("Roshini", 40000, "aws devops")
d.display()
m = Manager("kowshik", 52000, 8)
m.display()
i = Intern("sandeep", 25000, "python", 8)
i.display()




"""Problem Statement: Create a base class Vehicle with attributes brand and model. Then, create two derived classes Car and Bike, both inheriting from Vehicle, and adding their own attributes and methods.
...
car = Car("suziki", "Baleno", 4)
car.display()
bike = Bike("Benili", "350", "Sport")
bike.display()
...
tablet = Tablet("Samsung Galaxy Tab4", 10.1)
tablet.display()

smartphone = Smartphone("iPhone 16", "987-654-3210", 6.1, "iOS")
smartphone.display()
